...
public class LocalKafka {
    ...
    public LocalKafka(String zkConnection) {
        this(zkConnection, new Properties());
    }

    public LocalKafka(String zkConnection, Properties baseProperties) {
        this(zkConnection, baseProperties, Collections.singletonList(-1));
    }

    public LocalKafka(String zkConnection, Properties baseProperties, List<Integer> ports) {
